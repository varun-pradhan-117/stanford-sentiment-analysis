'''
Code adapted from https://github.com/huggingface/naacl_transfer_learning_tutorial
'''
...
from textProcessor import TextProcessor, read_sst5
from transformers import TransformerWithClfHeadAndAdapters
...
def train():
    ...
    parser.add_argument("--dataset_path", type=str, default='D:/Github stuff/Internship Stuff/stanford-sentiment-analysis/data', help="Directory to dataset.")
    ...
    processor = TextProcessor(tokenizer, label2int, max_length=256)
